...
public class ShowerWinkerController {
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/hero/final/report/shower/get/front/winker/signature", notes = "To get signature in Front Winker Final Report", response = HeroFinalReportShowerGetFrontWinkerSignatureSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/hero/final/report/shower/get/front/winker/testing/Version", notes = "To get Testing Version of Front Winker Final Report", response = HeroFinalReportShowerGetFrontWinkerTestingVersionSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/hero/final/report/shower/front/winker/delete/images", notes = "To Delete Images from Front Winker Final Report", response = HeroFinalReportShowerFrontWinkerDeleteImagesSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/hero/final/report/shower/front/winker/update", notes = "To Update in Front Winker Final Report", response = HeroFinalReportShowerFrontWinkerUpdateSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/hero/final/report/shower/front/winker/update/final/submit", notes = "To get Front Winker Final Report", response = HeroFinalReportShowerFrontWinkerUpdateFinalSubmitSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/hero/final/report/shower/front/winker/update/header", notes = "To update header of Front Winker Final Report", response = HeroFinalReportShowerFrontWinkerUpdateHeaderSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/hero/final/report/shower/rear/winker/delete/images", notes = "To Delete Images from Rear Winker Final Report", response = HeroFinalReportShowerRearWinkerDeleteImagesSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/hero/final/report/shower/rear/winker/insert/result", notes = "To Insert Results in Rear Winker Final Report", response = HeroFinalReportShowerRearWinkerInsertResultSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/hero/final/report/shower/rear/winker/update", notes = "To Update in Rear Winker Final Report", response = HeroFinalReportShowerRearWinkerUpdateSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/hero/final/report/shower/rear/winker/update/final/submit", notes = "To Final Submit of Rear Winker Final Report", response = HeroFinalReportShowerRearWinkerUpdateFinalSubmitSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/hero/final/report/shower/rear/winker/update/header", notes = "To update header of Rear Winker Final Report.", response = HeroFinalReportShowerRearWinkerUpdateHeaderSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/hero/final/report/shower/get/rear/winker/result", notes = "To get Rear Winker Result in Final Report", response = HeroFinalReportShowerGetRearWinkerResultSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/hero/final/report/shower/get/rear/winker/signature", notes = "To get signature in Rear Winker Final Report", response = HeroFinalReportShowerGetRearWinkerSignatureSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/hero/final/report/shower/get/rear/winker/testing/Version", notes = "To get Testing Version of Rear Winker Final Report", response = HeroFinalReportShowerGetRearWinkerTestingVersionSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
