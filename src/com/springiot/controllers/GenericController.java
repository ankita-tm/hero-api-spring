...
public class GenericController {
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/final/report/delete/before/after/test/images", notes = "To get the Final Report Insert Conclusion Data of Horn", response = FinalReportDeleteBeforeAfterTestImagesSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/hero/final/report/shower/tail/lamp/delete/images", notes = "Delete Hero Final Report Shower Get Tail Lamp Image", response = HeroFinalReportShowerTailLampDeleteImagesSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/hero/final/report/delete/relay/images", notes = "To delete Relay Final Report Images", response = HeroFinalReportDeleteRelayImagesSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/hero/final/report/delete/side/stand/images", notes = "To delete Side Stand Final Report Images", response = HeroFinalReportDeleteSideStandImagesSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/final/report/dust/delete/head/lamp/images", notes = "To Delete Final Report Dust Head Image", response = FinalReportDustDeleteHeadLampImagesSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/final/report/dust/delete/tail/lamp/images", notes = "To Delete Final Report Dust Tail Image", response = FinalReportDustDeleteTailLampImagesSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
	 ...
	 * @return Return the response message
	 */
	@ApiOperation(value = "/final/report/shower/delete/head/lamp/images", notes = "To Delete Final Report Shower Head Image", response = FinalReportShowerDeleteHeadLampImagesSwagger.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Record created successfully"),
			@ApiResponse(code = 201, message = " created successfully"),
			@ApiResponse(code = 400, response = Error.class, responseContainer = "List", message = "There was something wrong in the request and therefore could not be processed (headers, json syntax/content)"),
			@ApiResponse(code = 409, message = "ID already taken") })
