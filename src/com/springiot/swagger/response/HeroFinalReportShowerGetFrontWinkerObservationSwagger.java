...
/**
 * 
 * This class contains response on /hero/final/report/shower/get/front/winker/observation API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class HeroFinalReportShowerGetFrontWinkerObservationSwagger {
...
/**
	...
	private List<HeroFinalReportShowerGetFrontWinkerObservation> object;

	/**
	 * @return the object
	 */
	public List<HeroFinalReportShowerGetFrontWinkerObservation> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<HeroFinalReportShowerGetFrontWinkerObservation> object) {
		this.object = object;
	}
...
*/
class HeroFinalReportShowerGetFrontWinkerObservation {
	private int id; 
