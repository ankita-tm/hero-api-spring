...
/**
 * 
 * This class contains response on /final/report/shower/get/head/lamp/observation API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FinalReportShowerGetHeadLampObservationSwagger {
...
/**
	...
	private List<FinalReportShowerGetHeadLampObservation> object;

	/**
	 * @return the object
	 */
	public List<FinalReportShowerGetHeadLampObservation> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FinalReportShowerGetHeadLampObservation> object) {
		this.object = object;
	}
...
*/
class FinalReportShowerGetHeadLampObservation {
	private int id; 
