...
/**
 * 
 * This class contains response on /hero/final/report/shower/starter/get/relay/observation API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class HeroFinalReportShowerStarterGetRelayObservationSwagger {
...
/**
	...
	private List<HeroFinalReportShowerStarterGetRelayObservation> object;

	/**
	 * @return the object
	 */
	public List<HeroFinalReportShowerStarterGetRelayObservation> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<HeroFinalReportShowerStarterGetRelayObservation> object) {
		this.object = object;
	}
...
*/
class HeroFinalReportShowerStarterGetRelayObservation {
	private int id; 
