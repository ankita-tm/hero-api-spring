...
/**
 * 
 * This class contains response on /hero/final/report/lock/get/observation API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class HeroFinalReportLockGetObservationSwagger {
...
/**
	...
	private List<HeroFinalReportLockGetObservation> object;

	/**
	 * @return the object
	 */
	public List<HeroFinalReportLockGetObservation> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<HeroFinalReportLockGetObservation> object) {
		this.object = object;
	}
...
*/
class HeroFinalReportLockGetObservation {
	private int id; 
