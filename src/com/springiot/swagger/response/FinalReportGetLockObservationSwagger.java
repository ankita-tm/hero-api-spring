...
/**
 * 
 * This class contains response on /final/report/get/lock/observation API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FinalReportGetLockObservationSwagger {
...
/**
	...
	private List<FinalReportGetLockObservation> object;

	/**
	 * @return the object
	 */
	public List<FinalReportGetLockObservation> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FinalReportGetLockObservation> object) {
		this.object = object;
	}
...
*/
class FinalReportGetLockObservation {
	private int id; 
