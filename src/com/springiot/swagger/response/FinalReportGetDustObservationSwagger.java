...
/**
 * 
 * This class contains response on /final/report/get/dust/observation API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FinalReportGetDustObservationSwagger {
...
/**
	...
	private List<FinalReportGetDustObservation> object;

	/**
	 * @return the object
	 */
	public List<FinalReportGetDustObservation> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FinalReportGetDustObservation> object) {
		this.object = object;
	}
...
*/
class FinalReportGetDustObservation {
	private int id; 
