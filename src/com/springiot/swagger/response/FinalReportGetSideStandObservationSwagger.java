...
/**
 * 
 * This class contains response on /final/report/get/side/stand/observation API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FinalReportGetSideStandObservationSwagger {
...
/**
	...
	private List<FinalReportGetSideStandObservation> object;

	/**
	 * @return the object
	 */
	public List<FinalReportGetSideStandObservation> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FinalReportGetSideStandObservation> object) {
		this.object = object;
	}
...
*/
class FinalReportGetSideStandObservation {
	private int id; 
