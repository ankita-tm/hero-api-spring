...
/**
 * 
 * This class contains response on /final/report/get/horn/observation API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FinalReportGetHornObservationSwagger {
...
/**
	...
	private List<FinalReportGetHornObservation> object;

	/**
	 * @return the object
	 */
	public List<FinalReportGetHornObservation> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FinalReportGetHornObservation> object) {
		this.object = object;
	}
...
*/
class FinalReportGetHornObservation {
	private int id; 
