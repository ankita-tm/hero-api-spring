...
/**
 * 
 * This class contains response on /final/report/dust/get/tail/lamp/observation API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FinalReportDustGetTailLampObservationSwagger {
...
/**
	...
	private List<FinalReportDustGetTailLampObservation> object;

	/**
	 * @return the object
	 */
	public List<FinalReportDustGetTailLampObservation> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FinalReportDustGetTailLampObservation> object) {
		this.object = object;
	}
...
*/
class FinalReportDustGetTailLampObservation {
	private int id; 
