...
/**
 * 
 * This class contains response on /final/report/get/relay/observation API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FinalReportGetRelayObservationSwagger {
...
/**
	...
	private List<FinalReportGetRelayObservation> object;

	/**
	 * @return the object
	 */
	public List<FinalReportGetRelayObservation> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FinalReportGetRelayObservation> object) {
		this.object = object;
	}
...
*/
class FinalReportGetRelayObservation {
	private int id; 
