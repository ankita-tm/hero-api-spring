...
/**
 * 
 * This class contains response on /final/report/dust/get/head/lamp/observation API response
 * 
 * 
 * @author Ankita Shrothi
 *
 */
public class FinalReportDustGetHeadLampObservationSwagger {
...
/**
	...
	private List<FinalReportDustGetHeadLampObservation> object;

	/**
	 * @return the object
	 */
	public List<FinalReportDustGetHeadLampObservation> getObject() {
		return object;
	}
/**
	 * To set object
	 ...
	 * @param object
	 */
	public void setObject(List<FinalReportDustGetHeadLampObservation> object) {
		this.object = object;
	}
...
*/
class FinalReportDustGetHeadLampObservation {
